...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：修改铃声路径</td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top">
    <form action="UpdateSingServlet">
         铃声编号：<input type="text" name="singid" value="<%=singid %>"><br>
        铃声路径：  <input type="text" name="modify"><br>
