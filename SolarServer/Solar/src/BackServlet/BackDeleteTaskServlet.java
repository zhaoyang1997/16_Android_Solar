...
/**
 * Servlet implementation class BackDeleteTaskServlet
 */
@WebServlet("/BackDeleteTaskServlet")
public class BackDeleteTaskServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BackDeleteTaskServlet() {
        super();
